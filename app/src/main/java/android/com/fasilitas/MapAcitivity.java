            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    for (QueryDocumentSnapshot document : task.getResult()) {
                        ...
                        .snippet(facility.getUser().getBidang()));*/
                    }
                }
            }
        });
    ...
    private void addMapMarkers(){
        ...
        if(mMap != null){
            ...
            if(mClusterManager == null){
                mClusterManager = new ClusterManager<ClusterMarker>(MapAcitivity.this, mMap);
            }
...
//                        Log.d(TAG, "run: latlng: " + latLng.toString());
                    ...
                    polyline.setColor(ContextCompat.getColor(MapAcitivity.this, R.color.darkGrey));
    ...
    private void initMap() {
        ...
        mapFragment.getMapAsync(MapAcitivity.this);
    ...
    public void onInfoWindowClick(final Marker marker) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(MapAcitivity.this);
    ...
    public void onPolylineClick(Polyline polyline) {
        ...
        for (PolylineData polylineData : mPolylinesData) {
            ...
            if (polyline.getId().equals(polylineData.getPolyline().getId())) {
                polylineData.getPolyline().setColor(ContextCompat.getColor(MapAcitivity.this, R.color.blue1));
                ...
                *//*mTripMarkers.add(marker);*/
                ...
                polylineData.getPolyline().setColor(ContextCompat.getColor(MapAcitivity.this, R.color.darkGrey));
